    ...
    return (
        <>
            <Flex className="h-full w-64" align="center" justify="center" vertical>
                <Title level={5} ellipsis={{rows: 2}} className="text-center">{book.title}</Title>
                <Text>Średnia ocena użytkowników</Text>
                <Flex gap={'small'}>
                    ...
                    preview={{
                        imageRender: (image) => (
                            <div className="p-16 flex flex-row">
                                {image}
                                <div className="text-2xl w-full h-fit ml-8 mt-auto mb-auto p-4 bg-gray-900/90">
                                    <Text className="text-white">{book.description}</Text>
                                </div>
                            </div>
                        ),
                        toolbarRender: (
